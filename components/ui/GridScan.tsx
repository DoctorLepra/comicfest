    ...
    useEffect(() => {
        ...
        const onResize = () => {
            ...
            (material.uniforms.iResolution.value as THREE.Vector3).set(
                container.clientWidth, container.clientHeight, renderer.getPixelRatio()
            );
        ...
        const tick = () => {
            ...
            (material.uniforms.uSkew.value as THREE.Vector2).set(skewX, skewY);
        ...
        // Pause RAF when GridScan is not in the viewport
