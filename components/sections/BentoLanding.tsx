...
const TICKET_STYLES: Record<
  string,
  { spotlight: string; border: string; glow: string }
> = {
  general: {
    spotlight: "rgba(255, 255, 255, 0.22)",
                  ...
                  >
                    ...
                    <div className="p-10 flex flex-col flex-1">
                      ...
                      <div className="mb-10">
                        ...
                        <span className="text-cf-white/40 text-sm font-display ml-2">
                          COP
                        </span>
                      </div>
                      <ul className="space-y-4">
                        {ticket.features.map((f) => (
                          <li
                            key={f}
                            className="flex items-start gap-2.5 text-cf-white/60 text-sm font-display"
                          >
                            <Check
                              size={13}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {ACTIVITIES.map((activity, i) => {
              ...
              const href =
                LINKS[activity.slug] ?? `/actividades/${activity.slug}`;
                  ...
                  <BentoCard accentColor={activity.color} delay={i * 0.06}>
                    <div className="flex flex-col h-full min-h-[460px]">
                      ...
                      <div className="p-8 md:p-10 flex flex-col flex-1">
                        ...
                        <p className="text-cf-white/40 text-sm text-center mb-6">
                          {activity.subtitle}
                        </p>
                        ...
                        <ul className="space-y-3 mb-8">
                          {activity.features.map((f) => (
                            <li
                              key={f}
                              className="flex items-center gap-2 text-cf-white/50 text-sm font-display"
                            >
                              <span
                        ...
                        {(activity.slug === "copa-cosplay" ||
                          activity.slug === "kpop" ||
                          activity.slug === "esports") && (
