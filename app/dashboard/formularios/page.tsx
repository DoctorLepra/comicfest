      ...
      {selectedForm && (
        <div className="flex-1 flex flex-col bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden shadow-2xl min-h-0">
          ...
          {!loading && filteredSorted.length > PAGE_SIZE && (
            <div className="shrink-0 px-4 py-3 border-t border-white/10 bg-white/[0.02] flex items-center justify-between gap-4">
              <p className="text-xs text-white/40 font-mono">
                Mostrando {Math.min((currentPage - 1) * PAGE_SIZE + 1, filteredSorted.length)}–{Math.min(currentPage * PAGE_SIZE, filteredSorted.length)} de {filteredSorted.length} registros
              </p>
