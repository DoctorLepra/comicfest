...
export default function ExpositoresPage() {
  ...
  return (
    <div className="min-h-screen" style={{ paddingTop: "80px" }}>
      ...
      {/* ── Reasons grid ── */}
      <div ref={ref} className="px-6 md:px-12 pt-16 pb-8 flex flex-col items-center">
      ...
      {/* ── CTA section ── */}
      <div className="px-6 md:px-12 pb-20 pt-10 flex flex-col items-center">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ delay: 0.4, duration: 0.6 }}
          className="glass border border-cf-yellow/20 rounded-2xl p-10 md:p-14 w-full max-w-5xl mb-10 flex flex-col items-center"
        >
          <h2 className="font-display text-3xl md:text-4xl font-black text-cf-white mb-4 text-center">
            ¿LISTO PARA RESERVAR TU STAND?
          </h2>
          <p className="text-cf-white/60 font-body text-base max-w-xl mb-8 text-center">
